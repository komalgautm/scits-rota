...
<section id="container" >
    ...
    <section id="main-content">
        ...
        <div class="row" style="margin-bottom:30px;">
            ...
            <div class="col-md-2 col-lg-2">                
                <select class="form-control" name="service_user" id="service_user" <?php if(isset($_GET['key'])){ echo "disabled"; } ?>>
                                ...
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        @if($key['category_name'])
                                            <h1 class="title_time_log"><span style="color:{{$key['category_color']}};">{{ $key['category_name'] }}</span> | <span class="log_title">{{$key['title'] or null}}</span></h1>
                                        @else
                                            <h1 class="title_time_log"><span class="log_title">{{ $key['title'] or null }}</span></h1>
                                        @endif
                                        <p>{{ $key['details'] or null }}</p>                                        
                                        <h6 hidden>{{ $key['id'] }}</h6>
